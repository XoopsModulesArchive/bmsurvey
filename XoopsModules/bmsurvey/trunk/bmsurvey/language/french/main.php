...
define('_MD_BMSURVEY_LIST_TITLE', 'Titre');
define('_MD_BMSURVEY_LIST_UNAME', 'Propri騁aire');
define('_MD_BMSURVEY_LIST_DATE', 'Date');
define('_MD_BMSURVEY_LIST_SUBTITLE', 'Sous titre');
define('_MD_BMSURVEY_THANKS_ENTRY', "Merci d'avoir compl騁釥 ce formulaire!");
define('_MD_BMSURVEY_CAN_WRITE_USER_ONLY', 'Les Anonymes ne peuvent pas 馘iter de Formulaire!');
define('_MD_ASTERISK_REQUIRED', "LEs Questions marqu馥s d'un * doivent 黎re compl騁馥s.");
define('_MD_MISSING_REQUIRED', "Vous avez oubli&eacute; les questions obligatoires suivantes:");
define('_MD_MAIL_TITLE', 'Response de BMSURVEY:');
define("_MD_DENYRESULT","Interdire ce r&eacute,sultat");
define("_MD_DENYRESULTSURE","Interdire ce r&eacute;sultat. Etes vous s&ucirc;r ?");
define("_MD_DENYRESULTDONE","R&eacute;sultat interdit");
define('_MD_RESPONDENT','R&eacute;pondant');
