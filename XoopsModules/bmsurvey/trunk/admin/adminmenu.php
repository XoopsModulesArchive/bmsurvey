...
//	$tblCol[$currentoption] = 'current';
	...
	echo "<td style='width: 45%; font-size: 10px; text-align: left; color: #2F5376; padding: 0 6px; line-height: 18px;'><a class='nobutton' href='../../system/admin.php?fct=preferences&amp;op=showmod&amp;mod="
		...
		._AM_BMSURVEY_GOMOD."</a> | <a href='../docs/faq.php'>"
		._AM_BMSURVEY_FAQ."</a> | <a href='http://www.bluemooninc.biz/' target='_blank'>"
		._AM_BMSURVEY_SUPPORTSITE."</a></td>";
	echo "<td style='width: 55%; font-size: 10px; text-align: right; color: #2F5376; padding: 0 6px; line-height: 18px;'><b>"
		.$verinfo."</b></td>";	//$GLOBALS['ESPCONFIG']['name']."&nbsp;".$GLOBALS['ESPCONFIG']['version']
	echo "</tr></table>";
	echo "</div>";
	...
	echo "<li id='".$tblCol[4]."'><a href='resister.php'><span>"._AM_BMSURVEY_RESISTER."</span></a></li>";
	echo "<li id='".$tblCol[5]."'><a href='test.php'><span>"._AM_BMSURVEY_STATUS."</span></a></li>";
