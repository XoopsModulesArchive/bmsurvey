...
<li> Click "New field" by editing the survey. 
...
The answer result can be seen from the those who answer list box in "View Results from a Survey", 
and it can be set to the input value of default that "Set default input this result" 
is clicked here from the survey management tag of the module management. Moreover, release makes the survey 
from "Edit an Existing Survey" and choice General tab item Default Response delete response ID. 
...
<p>
<LI> Set Email at 'General' of the edit survey as the registration address of the mailing list. and choose 'In the questionnaire' as from option. 
<li> Field name 'Mailfrom' as text box - for from address. 
